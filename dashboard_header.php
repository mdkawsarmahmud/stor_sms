...
<head>
  ...
  <!-- Favicon icon -->
  <link rel="icon" type="image/png" sizes="16x16" href="/estor_sms/asset/images/favicon.png">
  <link rel="stylesheet" href="/estor_sms/asset//vendor/chartist/css/chartist.min.css">
  <link href="/estor_sms/asset/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
  <link href="/estor_sms/asset/vendor/owl-carousel/owl.carousel.css" rel="stylesheet">
  <link href="/estor_sms/asset/css/style.css" rel="stylesheet">
  <link
...
<body>
  ...
  <div id="main-wrapper">
    ...
    <div class="nav-header">
      <a href="index.html" class="brand-logo">
        <img class="logo-abbr" src="/estor_sms/asset/images/logo.png" alt="">
        <img class="logo-compact" src="/estor_sms/asset/images/logo-text.png" alt="">
        <img class="brand-title" src="/estor_sms/asset/images/logo-text.png" alt="">
      </a>
              ...
              <div class="card-body contacts_body p-0 dz-scroll  " id="DZ_W_Contacts_Body">
                <ul class="contacts">
                  ...
                  <li class="dz-chat-user">
                    <div class="d-flex bd-highlight">
                      <div class="img_cont">
                        <img src="/estor_sms/asset/images/avatar/4.jpg" class="rounded-circle user_img" alt="" />
                        <span class="online_icon offline"></span>
                      </div>
                      <div class="user_info">
                  ...
                  <li class="dz-chat-user">
                    <div class="d-flex bd-highlight">
                      <div class="img_cont">
                        <img src="/estor_sms/asset/images/avatar/5.jpg" class="rounded-circle user_img" alt="" />
                        <span class="online_icon offline"></span>
                      </div>
                      <div class="user_info">
                  ...
                  <li class="dz-chat-user">
                    <div class="d-flex bd-highlight">
                      <div class="img_cont">
                        <img src="/estor_sms/asset/images/avatar/1.jpg" class="rounded-circle user_img" alt="" />
                        <span class="online_icon"></span>
                      </div>
                      <div class="user_info">
                  ...
                  <li class="dz-chat-user">
                    <div class="d-flex bd-highlight">
                      <div class="img_cont">
                        <img src="/estor_sms/asset/images/avatar/2.jpg" class="rounded-circle user_img" alt="" />
                        <span class="online_icon offline"></span>
                      </div>
                      <div class="user_info">
                  ...
                  <li class="dz-chat-user">
                    <div class="d-flex bd-highlight">
                      <div class="img_cont">
                        <img src="/estor_sms/asset/images/avatar/3.jpg" class="rounded-circle user_img" alt="" />
                        <span class="online_icon"></span>
                      </div>
                      <div class="user_info">
            ...
            <div class="card chat dz-chat-history-box d-none">
              ...
              <div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
                ...
                <div class="d-flex justify-content-end mb-4">
                  ...
                  <div class="img_cont_msg">
                    <img src="/estor_sms/asset/images/avatar/2.jpg" class="rounded-circle user_img_msg" alt="" />
                  </div>
                </div>
                <div class="d-flex justify-content-start mb-4">
                  <div class="img_cont_msg">
                    <img src="/estor_sms/asset/images/avatar/1.jpg" class="rounded-circle user_img_msg" alt="" />
                  </div>
                  <div class="msg_cotainer">
            ...
            <ul class="navbar-nav header-right">
              ...
              <li class="nav-item dropdown header-profile">
                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                  <img src="/estor_sms/assetimages/profile/17.jpg" width="20" alt="" />
                      ...
                      <div class="items">
                        <div class="card text-center">
                          <div class="card-body">
                            ...
                            <h5 class="fs-16 font-w500 mb-1"><a href="app-profile.html" class="text-black">Roberto
                                Carloz</a></h5>
                      ...
                      <div class="items">
                        <div class="card text-center">
                          <div class="card-body">
                            ...
                            <h5 class="fs-16 font-w500 mb-1"><a href="app-profile.html" class="text-black">Ivankov
                                Smurz</a></h5>
                ...
                <div class="card featuredMenu">
                  ...
                  <div class="card-body loadmore-content height750 dz-scroll pt-0" id="FeaturedMenusContent">
                    ...
                    <ul class="d-flex flex-wrap pb-2 border-bottom mb-3 justify-content-between">
                      <li class="mr-3 mb-2"><i class="las la-clock scale5 mr-3"></i><span class="fs-14 text-black">4-6
                          mins </span></li>
                      <li class="mb-2"><i class="fa fa-star-o mr-3 scale5 text-warning" aria-hidden="true"></i><span
                    ...
                    <div class="media mb-4">
                      ...
                      <div class="media-body">
                        <h5><a href="food-menu.html" class="text-black fs-16">Original Boiled Egg with Himalaya Salt</a>
                        </h5>
  ...
  <!--**********************************
    ...
    ***********************************-->
  <!-- Required vendors -->
  <script src="/estor_sms/asset/vendor/global/global.min.js"></script>
  <script src="/estor_sms/asset/vendor/bootstrap-select/dist/js/bootstrap-select.min.js"></script>
  <script src="/estor_sms/asset/vendor/chart.js/Chart.bundle.min.js"></script>
  <script src="/estor_sms/asset/js/custom.min.js"></script>
  <script src="/estor_sms/asset/js/deznav-init.js"></script>
  <script src="/estor_sms/asset/vendor/owl-carousel/owl.carousel.js"></script>

  <!-- Chart piety plugin files -->
  <script src="/estor_sms/asset/vendor/peity/jquery.peity.min.js"></script>

  <!-- Apex Chart -->
  <script src="/estor_sms/asset/vendor/apexchart/apexchart.js"></script>

  <!-- Dashboard 1 -->
  <script src="/estor_sms/asset/estor_sms/asset/js/dashboard/dashboard-1.js"></script>
  <script>
